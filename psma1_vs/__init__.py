...
def enable_logging(
    ...
    logger.enable("psma1_vs")


if literal_eval(os.environ.get("PSMA1_VS_LOG", "False")):
    level = int(os.environ.get("PSMA1_VS_LOG_LEVEL", 20))
    stdout = literal_eval(os.environ.get("PSMA1_VS_STDOUT", "True"))
    log_file_path = os.environ.get("PSMA1_VS_LOG_FILE_PATH", None)
